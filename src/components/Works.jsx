    ...
    <>
      ...
      <div className="w-full flex">
        ...
        >
          ...
          take shape. In the 'Works' section, you'll find a curated collection of projects that showcase my passion for crafting meaningful digital 
          experiences. From sleek web applications to intuitive user interfaces, each project represents a journey of creativity,
